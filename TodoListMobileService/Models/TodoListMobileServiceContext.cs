...
namespace TodoListMobileService.Models
{

    public class TodoListMobileServiceContext : DbContext
    {
        ...
        public TodoListMobileServiceContext()
        ...
        public TodoListMobileServiceContext(string schema)
            : base(connectionStringName)
        {
            Schema = schema;
        }
